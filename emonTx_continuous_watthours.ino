...
unsigned long sendinterval = 5000; // milliseconds
String fudge = "";
...
rf69.setModemConfig(RH_RF69::GFSK_Rb2Fd5);
  ...
  Serial.println("rf module inited");
  Serial.println("init led");
  pinMode(LEDpin, OUTPUT); 
  digitalWrite(LEDpin, LED_ON); 
  delay(500);
  digitalWrite(LEDpin, LED_OFF); 
  Serial.println("led ok init ok !!");
...
void allGeneralProcessing()
{
  ...
  // store items for use uring next loop
...
fudge = "<OEM>";
fudge += tx_data.realPower_CT1;
fudge += ",";
fudge += tx_data.realPower_CT2;
fudge += ",";
fudge += tx_data.realPower_CT3;
fudge += ",";
fudge += tx_data.wh_CT1;
fudge += ",";
fudge += tx_data.wh_CT2;
fudge += ",";
fudge += tx_data.wh_CT3;
fudge += ",";
